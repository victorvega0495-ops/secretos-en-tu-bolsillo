...
export const campaigns: Campaign[] = [
  ...
  },
  {
    ...
    days: Array.from({ length: 7 }, (_, i) => ({
      day: i + 1,
      emoji: ["🔥", "🎯", "🎁", "👥", "⭐", "🔄", "🏆"][i],
      type: (["activacion", "prospeccion", "activacion", "prospeccion", "seguimiento", "seguimiento", "cierre"] as const)[i],
      typeLabel: ["Activación", "Prospección", "Activación + Promo", "Prospección", "Seguimiento", "Seguimiento", "Cierre"][i],
      focus: `Día ${i + 1}`,
